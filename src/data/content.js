export const content = {
  ...
  app: {
    title: 'РЕАЛЬНЫЕ ПРЕСТУПЛЕНИЯ',
    subtitle: 'Бруклинский Потрошитель. Выведи AI-маньяка на чистую воду!',
    aboutTitle: 'О проекте',
    aboutDescription: [
      '«Тру-крайм» — это детективная новелла, где вы общаетесь с персонажами как с живыми людьми, а не выбираете готовые реплики, что делает каждую сцену уникальной и непредсказуемой.',
			],
